...
public class Mot {
	...
	public int getPoints() {
		...
		// Pour chaque pion se trouvant dans la liste des pions du mot, on
		...
		for (Pion p : this.pions) {
			...
			// après des opérations spécifiques selon le type de la case qui
			// héberge le mot,
			// on ajoute au nombre de points du mot celui du pion.
			nbPointsMot += nbPointsPion;
		}
		// avant de retourner, on multiplie le nombre de points du mot (On
		// multiplie par 1 par défaut sinon 2 ou 3 pour respectivement les types
		// de cases MD ou MT
